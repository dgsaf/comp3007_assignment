...
We refer to the discussions of the finer details of the algorithms presented in
\autoref{sec:imp-overview} as a reflection on the performance, as many
challenges were experienced during development which led to the algorithms as
currently described.
Decisions, such as to identify the digits by their geometric sequential
properites, were made as a consequence of difficulties in early development of
the detection algorithm.
All algorithmic choices have been similarly motivated, and a comprehensive
discussion on these motivations is presented alongside the specific algorithms
for task 1 \autoref{sec:imp-1} and for task 2 \autoref{sec:imp-2}.
